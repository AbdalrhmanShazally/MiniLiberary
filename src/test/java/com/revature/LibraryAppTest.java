...
import com.revature.util.Application;
...
public class LibraryAppTest {
    ...
    @Test
    public void BookDAO_getBookWithBookCountOverZeroTest(){
        ...
        List<Book> availablebooks = bookDAO.getBookWithBookCountOverZero();
    ...
    @Test
    public void setBookService_getAllBooksTest1(){
     ...
     */
    @Test
    public void bookService_addBookVerifyNotNullSuccessfulAddTest(){
    List<Book> bookList = new ArrayList<>();
        Book b1 = new Book(101, 1, "Ulysses", 2);
        Book b2 = new Book(102, 1, "Finnegan's Wake", 0);
        Book b3 = new Book(103, 2, "War and Peace", 1);
    ...
    public void setBookService_getAllAvailableBooksTest(){
        ...
        Mockito.when(mockBookDAO.getAllBooks()).thenReturn(bookList);
        Mockito.when(mockBookDAO.getBookWithBookCountOverZero()).thenReturn(bookListOverZero);
